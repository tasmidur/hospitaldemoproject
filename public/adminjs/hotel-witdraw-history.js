...
$(document).ready(function(){
  ...
  $(document).on("click",".deletebtn",function(event){
    ...
    $.ajax({
      url:'/hotelbooking/hotel-payment-witdraw/delete',
      type:"post",
      data:{
          id:id
      },
      success:function(res){
        if(res){
            showNotification("Successfully deteted from the witdraw history",1);
  ...
  $(document).on("click",".cmf-withdraw",function(event){
    ...
    $.ajax({
      url:'/hotelbooking/hotel-payment-witdraw/payment-complete',
      type:"post",
      data:{
          id:id
      },
...
function data_load(from_date='',to_date=''){
  ...
  serverSide: true,
  ajax: {
   url:'/hotelbooking/hotel-withdraw-payment-history',
  },
  dom: 'lBfrtip',
  buttons: [
